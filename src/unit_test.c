...
START_TEST(sscanf_test_x_1) {
  ...
  Our_Lib = s21_sscanf("0x123456789012345", "%x", &x2);
  ck_assert_uint_eq(x1, x2);
  ck_assert_int_eq(Std_Lib, Our_Lib);
...
START_TEST(sscanf_test_all) {
  ...
  Std_Lib = sscanf("4 123 amogus q 12e34 43e21", "%i%d%9s%c%e%E", &i1, &d1,
                   suite, &c1, &e1, &E1);
  Our_Lib = s21_sscanf("4 123 amogus q 12e34 43e21", "%i%d%9s%c%e%E", &i2, &d2,
                       s2, &c2, &e2, &E2);
  ck_assert_int_eq(i1, i2);
  ck_assert_int_eq(d1, d2);
  ck_assert_str_eq(suite, s2);
  ...
  Our_Lib =
      s21_sscanf("4 123 amogus q 12e34 43e21 13.37 2.28", "%i%d%9s%c%e%E%f%g",
  ...
  Std_Lib = sscanf("4 123 amogus q 12e34 43e21 13.37 2.28 1337.228 101",
                   ...
                   &f_1, &g1, &G1, &o1);
  Our_Lib = s21_sscanf("4 123 amogus q 12e34 43e21 13.37 2.28 1337.228 101",
  ...
  Std_Lib = sscanf("4 123 amogus q 12e34 43e21 13.37 2.28 1337.228 101 1854",
                   ...
                   &f_1, &g1, &G1, &o1, &u1);
  Our_Lib =
      s21_sscanf("4 123 amogus q 12e34 43e21 13.37 2.28 1337.228 101 1854",
...
START_TEST(sscanf_test_s_2) {
  ...
  Our_Lib =
      s21_sscanf(" this is random string", "%*s%*s%10s%*s", str_vaOur_Lib);
